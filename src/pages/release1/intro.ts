...
export const introScenes = {
  intro: {
    page: 'intro',
    type: 'narration',
    text: ['Prologue', 'The private jet touched down smoothly on the foreign runway.'],
  ...
  intro_deal: {
    ...
    next: 'intro_ayesha_refused',
  },

  intro_ayesha_refused: {
    page: 'intro',
    type: 'narration',
    text: ['Ayesha Khan had refused to stay behind.'],
    next: 'intro_secretary',
  },
  ...
  intro_terminal: {
    page: 'intro',
    type: 'narration',
    text: ['In the crowded terminal, heads turned.'],
  ...
  intro_reveal: {
    page: 'intro',
    type: 'narration',
    text: ['The camera slowly revealed her face — Ayesha Khan.'],
    image: BG_AIRPORT_CROWD,
  ...
  intro_ayesha_secretary: {
    ...
    location: 'Foreign Airport - Terminal',
    image: BG_AIRPORT_CROWD,
    next: 'intro_flashback_title',
  },

  intro_flashback_title: {
    page: 'intro',
    type: 'narration',
    text: ['Flashback — Previous Night (Hotel Suite)'],
    next: 'intro_flashback_scene',
  },

  intro_flashback_scene: {
    page: 'intro',
    type: 'narration',
    text: [
    ...
    next: 'intro_flashback_ayesha',
  },

  intro_flashback_ayesha: {
    page: 'intro',
    type: 'dialogue',
    speaker: 'Ayesha',
    portrait: AYESHA,
    text: "Those people beneath us could never have what I have. I'm the only one who deserves to be here with you.",
  ...
  intro_snap_back: {
    page: 'intro',
    type: 'narration',
    text: ['Present again — the terminal hum, the exit signs, Richard at her side.'],
    image: BG_AIRPORT,
    next: 'intro_checking',
  },
  ...
  intro_toilet_exit: {
    page: 'intro',
    type: 'narration',
    text: ['She washed her hands, straightened her hijab, and stepped back out to wait near the exit.'],
    image: BG_AIRPORT,
